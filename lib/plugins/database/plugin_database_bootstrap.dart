...
void _registerTalmudSynopsis(String libraryPath) {
  ...
  PluginDatabaseRegistry.instance.register(PluginDatabaseSource(
    ...
    policy: PluginDatabasePolicy(
      ...
      allowedJoins: [
        PluginJoinRule(
          tableA: 'tractates', columnA: 'id',
          tableB: 'pages', columnB: 'tractate_id',
        ),
        PluginJoinRule(
          tableA: 'tractates', columnA: 'name_text_id',
          tableB: 'strings', columnB: 'id',
        ),
        PluginJoinRule(
          tableA: 'pages', columnA: 'name_text_id',
          tableB: 'strings', columnB: 'id',
        ),
        PluginJoinRule(
          tableA: 'pages', columnA: 'id',
          tableB: 'alignments', columnB: 'page_id',
        ),
        PluginJoinRule(
          tableA: 'alignments', columnA: 'reference_text_id',
          tableB: 'strings', columnB: 'id',
        ),
        PluginJoinRule(
          tableA: 'alignments', columnA: 'id',
          tableB: 'readings', columnB: 'alignment_id',
        ),
        PluginJoinRule(
          tableA: 'witnesses', columnA: 'id',
          tableB: 'readings', columnB: 'witness_id',
        ),
        PluginJoinRule(
          tableA: 'witnesses', columnA: 'name_text_id',
          tableB: 'strings', columnB: 'id',
        ),
        PluginJoinRule(
          tableA: 'readings', columnA: 'text_text_id',
          tableB: 'strings', columnB: 'id',
        ),
        PluginJoinRule(
          tableA: 'pages', columnA: 'id',
          tableB: 'page_witnesses', columnB: 'page_id',
        ),
        PluginJoinRule(
          tableA: 'witnesses', columnA: 'id',
          tableB: 'page_witnesses', columnB: 'witness_id',
        ),
      ],
      maxJoins: 8,
    ),
