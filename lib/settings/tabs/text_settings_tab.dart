          ...
          ListTile(
            ...
            trailing: SizedBox(
              ...
              child: AppDropdownField<String>(
                ...
                isExpanded: true,
                entries: const [
                  AppMenuEntry(value: 'same_line_after_brackets', label: 'אותה שורה אחרי (עם סוגריים)'),
                  AppMenuEntry(value: 'same_line_after_no_brackets', label: 'אותה שורה אחרי (בלי סוגריים)'),
                  AppMenuEntry(value: 'same_line_before_brackets', label: 'אותה שורה לפני (עם סוגריים)'),
                  AppMenuEntry(value: 'same_line_before_no_brackets', label: 'אותה שורה לפני (בלי סוגריים)'),
                  AppMenuEntry(value: 'separate_line_after', label: 'פסקה נפרדת אחרי'),
                  AppMenuEntry(value: 'separate_line_before', label: 'פסקה נפרדת לפני'),
                ],
                onSelected: (value) {
                  if (value != null) {
