...
class _ZmanCard extends StatelessWidget {
  ...
  /// מפת ההתראות הפעילות — לשימוש ב-composite cards עם 2 אייקונים
  ...
  double _titleFontSizeFor(CalendarTimeEntry timeData) {
    final base = timeData.name.length > 28
        ? 11.0
        : timeData.name.length > 20
            ...
            : timeData.name.length > 16
                ? 13.0
                : 14.0;
    return timeData.isComposite ? base + 1 : base;
  }
